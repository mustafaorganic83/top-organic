...
class KdsTicket extends BranchScopedModel
{
    ...
    {
        return ['priority' => 'integer', 'last_sequence' => 'integer', 'started_at' => 'immutable_datetime', 'ready_at' => 'immutable_datetime', 'cleared_at' => 'immutable_datetime', 'lock_version' => 'integer'];
    }
