...
{
    public const INVALID_INPUT = 'INVENTORY_INVALID_INPUT';

    public const SCOPE_VIOLATION = 'INVENTORY_SCOPE_VIOLATION';

    public const NOT_FOUND = 'INVENTORY_NOT_FOUND';

    public const INVALID_STATE = 'INVENTORY_INVALID_STATE';

    public const STALE_VERSION = 'INVENTORY_STALE_VERSION';

    public const IN_USE = 'INVENTORY_ENTITY_IN_USE';
    ...
    /** @param array<string, mixed> $context */
    public static function insufficientStock(string $message, array $context = []): self
    {
        return new self(self::INSUFFICIENT_STOCK, 422, $message, $context);
    }
